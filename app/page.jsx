  ...
  try {
    ...
    return (
      <main className="flex flex-col items-center justify-center space-y-6 h-screen w-full">
          ...
          <p className="w-1/2 truncate md:text-pretty">What is TalentTrail? Are you applying to fiftybajillion jobs every day and cant keep 
          ...
          <p className="w-1/2 truncate md:text-pretty">Blah blha blah blah tutorial what is this app explanation yada yada see the figma
